...
(function (Transport) {
    ...
    class VehicleStorage {
        ...
        getVehicleBySurname(surname) {
            return this.vehicles.filter(vehicle => vehicle.owner.surname.toUpperCase() === surname.toUpperCase());
        }
        sortByOwnerSurname() {
            return this._vehicles.sort((a, b) => a.owner.surname.localeCompare(b.owner.surname));
        }
        getVehiclesByOwnerSurnamePrefix(prefix) {
            return this._vehicles.filter(vehicle => vehicle.owner.surname.toUpperCase().startsWith(prefix.toUpperCase()));
        }
        get creationDate() {
