export namespace Transport {
    ...
    export interface IVehicleStorage<T extends IVehicle> {
        ...
        getVehiclesByOwnerSurnamePrefix(prefix: string): T[];
    }
    ...
    export class VehicleStorage<T extends Vehicle> implements IVehicleStorage<T> {
        ...
        getVehicleBySurname(surname: string): T[] {
            return this.vehicles.filter(vehicle => 
                vehicle.owner.surname.toUpperCase() === surname.toUpperCase()
            );
        }

        sortByOwnerSurname(): T[] {
            return this._vehicles.sort((a, b) => a.owner.surname.localeCompare(b.owner.surname));
        }

        getVehiclesByOwnerSurnamePrefix(prefix: string): T[] {
            return this._vehicles.filter(vehicle => 
                vehicle.owner.surname.toUpperCase().startsWith(prefix.toUpperCase())
            );
        }
    ...
    export class Motorbike extends Vehicle implements IMotorbike {
        ...
        constructor(
            brand: string, model: string, releaseYear: number, VIN: string,
        ...
        public getFrameInfo(): string {
            return `Тип рамы: ${this._frameType}, Спортивный: ${this._isSport ? "Да" : "Нет"}`;
        }
    }
}